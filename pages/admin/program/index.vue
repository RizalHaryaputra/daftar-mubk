      ...
      <div class="p-6 border-b border-brand-border/50 bg-gray-50/50 flex flex-col gap-4">
        ...
        <div class="flex flex-col sm:flex-row justify-between gap-4 items-center">
          <div class="relative w-full sm:w-80">
            ...
            <input v-model="searchQuery" class="w-full pl-11 pr-4 py-2.5 border border-brand-border/50 rounded-full text-sm bg-white focus:outline-none focus:border-brand-orange focus:ring-2 focus:ring-brand-orange/20 transition-all font-medium text-brand-brown shadow-sm" placeholder="Cari nama program..." />
          </div>
        </div>
        ...
        <div class="flex flex-wrap items-center gap-3 bg-brand-cream/30 p-3 rounded-xl border border-brand-border/50 shadow-sm">
          ...
          <select v-if="availablePeriodes.length > 0" v-model="periodeFilter" class="flex-1 min-w-[130px] px-4 py-2.5 rounded-lg border border-brand-border/50 bg-white focus:outline-none focus:border-brand-orange focus:ring-2 focus:ring-brand-orange/20 text-brand-brown font-medium cursor-pointer text-xs appearance-none">
            <option value="semua">Semua Periode</option>
            <option v-for="p in availablePeriodes" :key="p" :value="p">{{ p }}</option>
          </select>
          <select v-model="statusFilter" class="flex-1 min-w-[130px] px-4 py-2.5 rounded-lg border border-brand-border/50 bg-white focus:outline-none focus:border-brand-orange focus:ring-2 focus:ring-brand-orange/20 text-brand-brown font-medium cursor-pointer text-xs appearance-none">
