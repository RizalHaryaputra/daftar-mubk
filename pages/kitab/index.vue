<template>
  <div class="space-y-12 pb-20 pt-8">
    ...
    <div v-else class="text-center py-20 bg-white/50 rounded-[40px] max-w-3xl mx-auto border border-brand-border border-dashed">
      ...
      <p class="text-xl font-display text-brand-brown mb-2">Belum ada koleksi kitab</p>
      <p class="text-brand-muted">Koleksi kitab sedang dipersiapkan, silakan kembali lagi nanti.</p>
    </div>
  </div>
</template>
